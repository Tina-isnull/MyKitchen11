...
//为什么用NineGridLayout会不可用public修饰
public class NineGridLayout extends ViewGroup {
    ...
    private void layoutChildrenView() {
        ...
        for (int i = 0; i < childrenCount; i++) {
           ...
           // childrenView.setImageUrl(((Image) listData.get(i)).getUrl());text
           // childrenView.setImageResource(listData.get(i).getImg());
            //ImageLoader.getInstance().displayImage(listData.get(i).getImgUrl(), childrenView);
            HttpRequestManager.displayImage(listData.get(i).getImgUrl(), childrenView);
